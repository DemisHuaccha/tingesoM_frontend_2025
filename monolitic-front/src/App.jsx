        ...
        <div className="main-content">
          <Routes>
            ...
            <Route path='/ListClients'
              element={<PrivateRoute element={<ListClientComponent />} rolesAllowed={["USER", "ADMIN"]} />}
            />

            <Route path="/add-Client"
              element={<PrivateRoute element={<ClientComponent />} rolesAllowed={["USER", "ADMIN"]} />}
            />
            ...
            <Route path="/reports"
              element={<PrivateRoute element={<ReportsPage />} rolesAllowed={["USER", "ADMIN"]} />}
            />
